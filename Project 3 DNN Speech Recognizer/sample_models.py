...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        name_rnn='rnn_'+str(i+1)
        name_batch_norm='batch_norm_'+str(i+1)
        
        # TODO: Add recurrent layers, each with batch normalization
        simp_rnn = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name=name_rnn)(prev_layer)
        
        bn_rnn = BatchNormalization(name=name_batch_norm)(simp_rnn)
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='bidirectional_rnn'))(input_data)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def final_model(input_dim, conv_border_mode, units, output_dim=29):
    ...
    #max pooling layer
    max_pool_1 = MaxPooling1D(pool_size=3, strides=1, padding='same',
                            name='maxpool_1d_1')(conv_1d_1)
    
    #1d convolutional layer
    conv_1d_2 = Conv1D(filters=64, 
                       kernel_size=3, 
                       strides=1, 
                       padding='same',
                       activation='relu',
                       name='conv1d_2')(max_pool_1)
